...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto mt-8 px-4">
        ...
        <form action="<?= base_url('productos/store') ?>" method="post" class="bg-white p-6 shadow-md rounded">
            <div class="mb-4">
                <label for="nombre" class="block text-sm font-medium text-gray-700">Nombre:</label>
                <input type="text" name="nombre" class="mt-1 p-2 border rounded w-full" required>
            </div>
            <div class="mb-4">
                <label for="descripcion" class="block text-sm font-medium text-gray-700">Descripción:</label>
                <input type="text" name="descripcion" class="mt-1 p-2 border rounded w-full" required>
            </div>
            <div class="mb-4">
                <label for="precio" class="block text-sm font-medium text-gray-700">Precio:</label>
                <input type="number" name="precio" class="mt-1 p-2 border rounded w-full" required>
            </div>
